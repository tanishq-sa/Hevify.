    ...
    <SafeAreaView className={`flex-1 ${isDark ? 'bg-background-dark' : 'bg-background'}`} edges={['top']}>
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="px-4 py-3">
          <View className={`flex-row items-center ${isDark ? 'bg-background-dark' : 'bg-background'} rounded-lg px-3 py-2`}>
            <TextInput
              value={routineNotes}
              ...
              multiline
            />
            <View className={`w-8 h-8 rounded-full ${isDark ? 'bg-background-dark' : 'bg-background'} items-center justify-center ml-2`}>
          ...
          <View key={exercise.id} className="px-4 mb-4">
            ...
            <View className="flex-row items-center justify-between mb-3">
              <View className="flex-row items-center flex-1">
                <View className={`w-12 h-12 rounded-full ${isDark ? 'bg-background-dark' : 'bg-background'} items-center justify-center mr-3`}>
