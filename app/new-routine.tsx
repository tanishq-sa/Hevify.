      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        {exercises.map((exercise) => (
          <View key={exercise.id} className="px-4 mb-4">
            ...
            {/* Exercise Notes */}
            <View className={`mb-3 ${isDark ? 'bg-card-dark' : 'bg-card'} rounded-lg px-3 py-2`}>
              <TextInput
            ...
            {/* Sets Table */}
            <View className={`${isDark ? 'bg-card-dark' : 'bg-card'} rounded-lg overflow-hidden mb-3`}>
              {/* Table Header */}
              <View className={`flex-row ${isDark ? 'bg-muted-dark' : 'bg-muted'} px-3 py-2 border-b ${isDark ? 'border-border-dark' : 'border-border'}`}>
            ...
            <Pressable
              ...
              className={`${isDark ? 'bg-card-dark' : 'bg-card'} rounded-lg py-3 items-center mb-4`}
            >
